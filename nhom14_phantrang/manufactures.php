...
<div id="user-nav" class="navbar navbar-inverse">
	<ul class="nav">
		<li  class="dropdown" id="profile-messages" ><a title="" href="form.html" data-toggle="dropdown" data-target="form.phpprofile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome Super Admin</span><b class="caret"></b></a>
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tr class="">
								<td>5</td>
								<td>HONDA WINNER</td>
								<td><img src="public/images/winner_150.jpg" style="width:100px"></td>
								<td>
							...
							<tr class="">
								...
								<td><img src="public/images/yamaha-exciter-2019-tai-dai-ly-4.png" style="width:100px"></td>
								<td>
									<a href="#" class="btn btn-success btn-mini">Edit</a>
									<a href="#" class="btn btn-danger btn-mini">Delete</a>
								</td>
							...
							<tr class="">
								<td>1</td>
								<td>HONDA SH125</td>
								<td><img src="public/images/sh_1905367.jpeg" style="width:100px"></td>
								<td>
									<a href="#" class="btn btn-success btn-mini">Edit</a>
									<a href="#" class="btn btn-danger btn-mini">Delete</a>
								</td>
